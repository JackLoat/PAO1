    ...
    , ui(new Ui::MainWindow)
{
    ...
    //ricerca = new QPushButton("Ricerca",this);
    ...
    //browseLayout->addWidget(barra_ricerca);
    //browseLayout->addWidget(ricerca);
...
*/
    ...
    //connect(ricerca, &QPushButton::clicked, this, &MainWindow::onRicercaClicked);
...
void MainWindow::on_sensorClicked(QListWidgetItem* item){
    ...
    box_sensore->icona->setPixmap(pixmap);

    //QPixmap pixmap(item->icon());    //MODIFICA PRIMA DELLA CONSEGNA!!!
    //QLabel* label_icona = box_sensore->icona;

    ...
    , ui(new Ui::MainWindow)
{
    ...
    //mostra_sensori->setGraphicsEffect(shadowEffect);
    ...
    //buttonLayout->addWidget(aggiungi_sensore, 0, 0, Qt::AlignBottom | Qt::AlignRight); // Posiziona il pulsante in basso a destra

    //gridLayout->addWidget(buttonContainer);
...
void MainWindow::on_sensorClicked(QListWidgetItem* item){
    ...
    //qDebug()<<"inizio cambio icona mainwindow::on sensorclicked";
        //da rimuovere
...
//    box_sensore->setIcona(pixmap);
    ...
    //qDebug()<<"fine cambio icona mainwindow::on sensorclicked";
    ...
    //qDebug()<<"inizio mainwindow::on_sensor_clicked::unire i puntini";
    sensor->accept(visitor);
    chartBox* box_grafo = visitor->getWidget();
    //qDebug()<<"estratto il widget, ora va aggiunto al layout";

    QVBoxLayout* layout = new QVBoxLayout;
    layout->addWidget(box_grafo);
    resetChartBox();
    chartContainer->setLayout(layout);
    //qDebug()<<"fine mainwindow::on_sensor_clicked::unire i puntini";
...
void MainWindow::fileToWidgetList(const QString& path){
    ...
    while (!in.atEnd()) {
        ...
        //qDebug()<<"inizio toppa sensor2WI";
        //sensor->sensorToWI(*item);
        //settare i campi dell'item con i dati del sensore:
        /*
        item.setText(nome);
...
*/
        ...
        //qDebug()<<"inizio cambio icona mainwindow::file2Widget list";
            //da rimuovere
        //item->setIcon(*(sensor->getIcona()));
            //test
        item->setIcon(*(new QIcon(":/resources/resources/asset/icona_sensore_"+sensor->getTipo())));
        //qDebug()<<"fine cambio icona mainwindow::file2widgetList";

        //qDebug()<<"fine toppa sensor2WI";
